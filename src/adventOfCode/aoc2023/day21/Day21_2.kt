...
fun main() = solve { lines ->
    ...
    for (i0 in 0..<n) for (j0 in 0..<m) if (a[i0][j0] == 'S') {
        var q0 = ArrayDeque<Point>()
        var q1 = ArrayDeque<Point>()
        val u = HashSet<Point>()
        fun enq(i: Int, j: Int) {
